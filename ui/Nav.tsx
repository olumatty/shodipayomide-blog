   ...
   <Tooltip.Provider>
     <Tooltip.Root>
       <Tooltip.Trigger asChild>
         <Link href={href} className={clsx("group", FOCUS_VISIBLE_OUTLINE)} target="_blank" rel="noopener noreferrer">
           <div className="flex items-center sm:space-x-3">
             <div className="mb-0 flex justify-center sm:mb-0 sm:block">
               <div className={clsx(
                 ...
                 {
                   "ring-[2px] ring-gray-800/30 ring-offset-1 ring-offset-black/5": isActive,
                 },
               )}>
       ...
       <Tooltip.Portal>
         <Tooltip.Content 
           className="rounded bg-black/80 backdrop-blur-md px-2 py-1 text-sm text-white"
           sideOffset={5}
         >
           {children}
...
export const Nav = () => {
  return (
    <div className="flex flex-wrap items-center gap-4 text-base font-medium leading-none text-rose-100/90">
      <NavItem href="https://github.com/developerayo" Icon={() => (
        <FontAwesomeIcon icon={faGithub} className="w-[24px] h-[24px]" />
      )}>
        GitHub
      </NavItem>

      <NavItem href="/blog" Icon={() => (
        <FontAwesomeIcon icon={faBook} className="w-[24px] h-[24px]" />
      )}>
        Blog
      </NavItem>

      <NavItem href="https://twitter.com/developerayo" Icon={() => (
        <FontAwesomeIcon icon={faXTwitter} className="w-[24px] h-[24px]" />
      )}>
        X
      </NavItem>

      <NavItem href="https://shodipoayomide.com" Icon={() => (
