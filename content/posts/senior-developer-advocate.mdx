...
<Img src={`/vercel-hydra.jpg`} alt="" bleed={false} width={1200} height={900}>
...
As a new Developer Advocate, you inevitably have to choose between quality and speed. It can be tempting to want to prove yourself by producing lots of work but it shouldn’t be at the cost of quality. One thing that I quickly learned about creative work is that _takes time_.
