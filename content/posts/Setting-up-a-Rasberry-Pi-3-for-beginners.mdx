---
title: "Setting up a Raspberry Pi 3 for beginners"
...
<div className="flex justify-center">
  <Img
    src="https://res.cloudinary.com/developerayo/image/upload/f_png,q_auto:best/v1557992620/samm-market-app-banner-03.png"
    alt="Samm Market App banner"
    width={300}
    height={200}
  />
</div>
...
<div className="flex justify-center">
  <Img
    src="https://res.cloudinary.com/developerayo/image/upload/q_auto:best/v1558122254/models.png"
    alt="Comparison table or image of Raspberry Pi models"
    width={800}
    height={400}
  />
</div>
...
<div className="flex justify-center">
  <Img
    src="https://res.cloudinary.com/developerayo/image/upload/q_100/v1558122254/Rasberrypi3_plus_Raspbian-Logo.png"
    alt="Raspberry Pi 3 and Raspbian logo"
    width={800}
    height={400}
  />
</div>
...
<div className="flex justify-center">
  <Img
    src="https://res.cloudinary.com/developerayo/image/upload/v1558122641/my-ports.jpg"
    alt="Image showing the ports on a Raspberry Pi"
    width={800}
    height={400}
  />
</div>
...
<div className="flex justify-center">
  <Img
    src="https://res.cloudinary.com/developerayo/image/upload/e_bgremoval/v1557941871/pi-labelled.png"
    alt="Labelled diagram of the Raspberry Pi"
    width={700}
    height={400}
  />
</div>
...
<div className="flex justify-center">
  <Img
    src="https://res.cloudinary.com/developerayo/image/upload/c_scale,w_1874/v1557941876/D5WKSvbXoAAu1oa.jpg"
...
<div className="flex justify-center">
  <Img
    src="https://res.cloudinary.com/developerayo/image/upload/v1558122289/spark_gif.gif"
    alt="Sparking animation GIF"
    width={700}
    height={400}
  />
</div>
